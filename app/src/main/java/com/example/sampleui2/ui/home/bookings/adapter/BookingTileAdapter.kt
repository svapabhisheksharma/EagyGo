...
class BookingTileAdapter(val list:List<BookingTileModel>, val pageType:Int):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType){
            ...
            2-> VHText(LayoutInflater.from(parent.context).inflate(R.layout.booking_tile_rv_item_textbody,parent,false))
            3-> VHSimple(LayoutInflater.from(parent.context).inflate(R.layout.booking_tile_rv_item_photoid,parent,false))
