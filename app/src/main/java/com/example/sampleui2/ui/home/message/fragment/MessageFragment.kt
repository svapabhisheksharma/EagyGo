package com.example.sampleui2.ui.home.message.fragment
...
class Page40Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        val list = listOf<MessageModel>(
                ...
                MessageModel("Stephen Mann",R.drawable.ic_ciggarate,activity),
                MessageModel("Malvin Pratt",R.drawable.ic_pets,activity),
                MessageModel("Shane Martinez",R.drawable.ic_petrol,activity),
                MessageModel("Katie Keller",R.drawable.ic_gear,activity),
                MessageModel("Stephen Mann",R.drawable.ic_ciggarate,activity),
                MessageModel("Malvin Pratt",R.drawable.ic_pets,activity)
