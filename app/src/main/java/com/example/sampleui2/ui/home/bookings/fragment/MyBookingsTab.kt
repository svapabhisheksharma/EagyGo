...
import com.example.sampleui2.ui.home.bookings.adapter.MyBookingsAdapter
...
class Page14Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.booking_fragment_tab_my_bookings, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        rv.adapter = MyBookingsAdapter(list,activity)
